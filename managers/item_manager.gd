...
const AFFIXES_PATH = "res://items/data/affixes.json"
const RARE_NAMES_PATH = "res://items/data/rare_names.json"
...
var usable = {
	"healing": preload( "res://items/usable/item_healing.gd" ),
	"upgrade": preload( "res://items/usable/item_upgrade.gd" ),
}
